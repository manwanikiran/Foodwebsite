	...
	<div id="rev_slider_45_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;" data-version="5.4.8">
		<ul>
			...
			<li data-index="rs-66" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="600" data-thumb="" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
				<img src="{{URL::to('/')}}/frontassets/html_rtl/revolution-slider/assets/images/slide_5.jpg" alt="" data-bgposition="center center" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0" data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
			...
			<li data-index="rs-68" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="600" data-thumb="" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
				<img src="{{URL::to('/')}}/frontassets/html_rtl/revolution-slider/assets/images/slide_3.jpg" alt="" data-bgposition="center center" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0" data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
...
<div class="container margin_60_40">
	<div class="main_title">
		...
		<a href="/restaurantlist">View All</a>
	</div>
		...
		<div class="item">
			<div class="strip">
				<figure>
					...
					<img src="{{URL::to('/')}}/uploads/restaurant/{{$row->res_coverimg}}" data-src="{{URL::to('/')}}/uploads/restaurant/{{$row->res_coverimg}}" style="height: 200px;width: 300px;" class="owl-lazy" alt="">
				...
				<ul>
					...
					<div class="score"> Reviews<span><em> </em></span><strong>{{$row->reviewcount}}</strong> </div>
						...
						<!-- <div class="score"><span>Superb<em>{{$row->reviewcount}} Reviews</em></span><strong>8.9</strong></div> -->
					</li>
				</ul>
			</div>
		</div>
	...
	<!-- /carousel -->
	<br><br>
	<div class="banner lazy" data-bg="url({{URL::to('/')}}/uploads/restaurantindex/res3.png)">
		<div class="wrapper d-flex align-items-center opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.2)">
			<div>
				<small>Food Plaza</small>
				<h3>All Restaurants</h3>
				<p>Best food at the best price</p>
				<a href="/restaurantlist" class="btn_1">View All</a>
			</div>
		</div>
		<!-- /wrapper -->
	</div>
				...
				<ul>
					...
					<li>
						<a href="detail-restaurant.html">
							<figure>
								<img src="{{URL::to('/')}}/uploads/restaurantindex/discount.png" data-src="{{URL::to('/')}}/uploads/restaurantindex/discount.png" alt="" class="lazy">
							</figure>
							<!-- <div class="score"><strong>9.5</strong></div> -->
							<!-- <em>Italian</em> -->
							<h3>{{$row->offer_title}}</h3>
							<small>{{$row->offer_description}}</small>
							<ul>
								<li><span class="ribbon off">{{$row->offer_discount}}</span></li>
		...
		<div class="owl-carousel owl-theme categories_carousel">
			...
			<div class="item">
				<a href="#0">
					...
					<img src="{{URL::to('/')}}/uploads/category/{{$row->cate_img}}" style="height: 200px;width: 200px;" alt="">
					<br><br>
					<h3>{{$row->cate_name}}</h3>
	...
	<div class="container clearfix">
		<div class="col-lg-5 col-md-6 float-end wow">
			<div class="box_1">
				...
				<a href="/resregistration" class="btn_1">Sign Up</a>
			</div>
		</div>
	</div>
</div>
