							...
							<div class="card-body">
								...
								<div class="border p-4 rounded">
									<div class="text-center mb-4">
										<h3 class="">Delivery Boy Sign in</h3>
									...
									<div class="form-body">
									<form action="/checkdeliverylogin"class="row g-4" method="post">
									@csrf
									@if($error = Session::get('error'))
										...
										<!-- <form class="row g-4"> -->
											...
											<div class="col-md-6 text-end"> <a href="/delboyforgetpassword">Forgot Password ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
											...
											<div class="col-12 text-center">
												<p class="mb-0">Don't have an account yet? <a href="/deliveryregister">Sign up here</a>
												</p>
											</div>
										<!-- </form> -->
									</div>
