...
<head>
	...
	<!--favicon-->
	<link href="{{URL::to('/')}}/uploads/restaurantindex/foodlogo.png" type="image/png" />
	<!--plugins-->
						...
						<div class="card shadow-none">
							<div class="card-body">
								...
								<div class="border p-4 rounded">
									...
									<div class="form-body">
									<form action="/checklogin"class="row g-4" method="post">
									@csrf
									@if($error = Session::get('error'))
										...
										<!-- <form class="row g-4"> -->
											...
											<div class="col-md-6 text-end"> <a href="/forgetpassword">Forgot Password ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
