...
<div class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="/addresblog"><button type="button" class="btn btn-primary">Add blog</button></a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-danger deletebtn" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal" data-id="{{$row->blog_id}}" data-img="{{$row->blog_img}}">Delete</button>
                                <a href="/updateresblog/{{$row->blog_id}}"><button class="btn btn-primary">Update</button></a>
                            </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="/deleteresblog" method="post">
                    @csrf
