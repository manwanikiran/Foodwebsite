    ...
    <div class="row">
        <div class="col-xl-9 mx-auto">
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body">
                    <form id="form1" action="/edititem" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="text" hidden name="edititem" id="edititem" value="{{$item->item_id}}">
                        <div class="border p-4 rounded">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select type="text" class="form-control" id="food" name="food">
                                        <option value="">Enter Food</option>
                                        @foreach($food as $row)
                                        <option @if(($row->food_id)==($item->food_id)) selected @endif value="{{$row->food_id}}"->{{$row->food_title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="itemqty" name="itemqty" value="{{$item->item_qty}}" placeholder="Enter Food Title">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="itemprice" name="itemprice" value="{{$item->item_price}}" placeholder="Enter Food Type">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="itemstatus" value="{{$item->item_status}}" name="itemstatus">
                                </div>
                            </div>
