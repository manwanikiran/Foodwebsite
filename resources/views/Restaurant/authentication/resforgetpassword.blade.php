    ...
    <div class="wrapper">
        <div class="authentication-forgot d-flex align-items-center justify-content-center">
            <div class="card forgot-box shadow-none">
                <div class="card-body">
                    <form action="/rescheckforgetpass" class="row g-4" method="post">
                        @csrf
                        ...
                        <div class="p-4 rounded  border">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-lg">Send</button> <a href="/restaurantindex" class="btn btn-light btn-lg"><i class='bx bx-arrow-back me-1'></i>Back to Login</a>
                            </div>
                        </div>
                    </form>
                </div>
